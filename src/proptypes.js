...
export const toggleSearchFieldDisplayPropType = PropTypes.func.isRequired;
...
export const isSearchFieldDisplayedPropType = PropTypes.bool;
export const isFilterFieldDisplayedPropType = PropTypes.bool;
